...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_60_ansi(
        ...
        _______, RGB_HUI, RGB_SAI, RGB_VAI, RGB_TOG, RGB_MOD,  RGB_SAI, _______, _______, _______, _______, _______, _______, _______,
        KC_CAPS, RGB_HUD, RGB_SAD, RGB_VAD, _______, RGB_RMOD, RGB_SAD, _______, _______, KC_PAUS, KC_INS,  KC_SCRL,          _______,
