...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_FN1] = LAYOUT(
        ...
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_NO,    KC_DEL,   _______,
        ...
        _______,  KC_NO,    _______,  _______,  _______,  _______,  _______,  KC_END,   _______,  _______,  _______,  _______,  _______,            KC_PGUP,  _______,
	...
	[_FN2] = LAYOUT(
        ...
        _______,  UG_HUEU,  UG_SATU,  UG_VALU,  UG_TOGG,  UG_PREV,  UG_SPDU,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        KC_CAPS,  UG_HUED,  UG_SATD,  UG_VALD,  _______,  UG_NEXT,  UG_SPDD,  _______,  _______,  KC_PAUS,  KC_INS,   KC_SCRL,            _______,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
        _______,  _______,  _______,                      KC_NO,    _______,  KC_NO,                        _______,  _______,  _______,  _______,  _______,  _______
    )
};
