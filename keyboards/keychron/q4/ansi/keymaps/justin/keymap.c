...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_61(
        ...
        KC_LCTL,  KC_LOPT,  KC_LCMD,                            KC_SPC,                             KC_RCMD,  KC_ROPT,  MO(_HWFN), KC_RCTL),

    [WIN_BASE] = LAYOUT_ansi_61(
        _______,  _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______,   _______,
        _______,  _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______,   _______,
        MO(_FN1), _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,             _______,
        _______,  _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______,  
        KC_LCTL,  KC_LGUI,  KC_LALT,                            _______,                            KC_RALT,  KC_RGUI,  _______,   KC_RCTL),
    ...
    [_HWFN] = LAYOUT_ansi_61( 
        QK_BOOT, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,
        XXXXXXX, RM_HUEU,  RM_SATU, RM_VALU, RM_TOGG, RM_PREV, RM_SPDU, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,
        KC_CAPS, RM_HUED,  RM_SATD, RM_VALD, XXXXXXX, RM_NEXT, RM_SPDD, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,             XXXXXXX,
